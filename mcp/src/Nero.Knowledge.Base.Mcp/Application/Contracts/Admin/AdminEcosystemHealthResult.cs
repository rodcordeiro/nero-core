...
public sealed record AdminEcosystemHealthResult
{
    ...
    public IReadOnlyList<AdminEcosystemScopeHealthResult> ProjectsWithIssues { get; init; } = [];

    public IReadOnlyList<AdminEcosystemScopeHealthResult> DomainsWithIssues { get; init; } = [];
}
