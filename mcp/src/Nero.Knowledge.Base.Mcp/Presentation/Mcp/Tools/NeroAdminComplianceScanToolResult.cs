...
public sealed record NeroAdminComplianceScanIssueToolResult
{
...
public sealed record NeroAdminComplianceScanToolResult
{
    ...
    public required IReadOnlyList<NeroAdminComplianceScanIssueToolResult> ActiveHits { get; init; }

    public required IReadOnlyList<NeroAdminComplianceScanIssueToolResult> QuarantinedHits { get; init; }

    public required IReadOnlyList<NeroAdminComplianceScanIssueToolResult> Warnings { get; init; }
